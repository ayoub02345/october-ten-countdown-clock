...
const translations = {
  ar: {
    ...
    'supportDescription': 'ستنهي مايكروسوفت دعم ويندوز ١٠ في ١٤ أكتوبر ٢٠٢٥. الوقت المتبقي حتى انتهاء الدعم:',
    ...
    'october14': '١٤ أكتوبر ٢٠٢٥',
    'utcTime': '١٢:٠٠ ص بالتوقيت العالمي',
    'importantInformation': 'معلومات مهمة',
    'warningText': 'بعد ١٤ أكتوبر ٢٠٢٥، لن تقوم مايكروسوفت بتوفير تحديثات الأمان أو إصلاحات الأخطاء أو الدعم التقني لويندوز ١٠. فكر في الترقية إلى ويندوز ١١ أو استكشاف أنظمة التشغيل البديلة لضمان بقاء جهازك آمناً.',
    'footerText': 'هذا العد التنازلي يتتبع النهاية الرسمية لدعم ويندوز ١٠ كما أعلنت مايكروسوفت'
  },
  en: {
